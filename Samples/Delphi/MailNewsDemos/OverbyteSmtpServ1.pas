...
Sep 20, 2013 V8.00 Angus created



 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
unit OverbyteSmtpServ1;
...
const
    SmtpServerTestVersion    = 8.00;
    CopyRight : String = ' OverbyteSmtpServer (c) 1997-2013 F. Piette V8.00 ';
...
begin
    ...
    begin
        ...
        if PrefAllowRelay.Checked then
            Options := Options + [smtpsAllowRelay]
        else
            Options := Options - [smtpsAllowRelay];
