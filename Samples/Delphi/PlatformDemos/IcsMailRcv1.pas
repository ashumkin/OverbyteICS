...
begin
    ...
    InfoLabel.Text            := MethodName + ' started';
    try
        MethodPtr;
        InfoLabel.Text := MethodName + ' ok';
    except
        on E:Exception do begin
            System.SysUtils.Beep;
            InfoLabel.Text := MethodName + ' failed (' + E.Message + ')';
        end;
    end;
end;
...
begin
    MessageForm.DisplayMemo.Lines.Clear;
    MessageForm.Caption       := 'Message';
