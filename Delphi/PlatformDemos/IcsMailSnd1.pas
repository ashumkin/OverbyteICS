...
type
  TSmtpTestForm = class(TForm)
    ...
    BasicSettingsTabSheet: TTabItem;
    Label1: TLabel;
    HostEdit: TEdit;
    Label4: TLabel;
    PortEdit: TEdit;
    ...
    CharsetSettingsTabSheet: TTabItem;
...
begin
    ...
    if ProgressCheckBox.IsChecked then begin
...
begin
    ...
    ConfirmCheckBox.IsChecked    := Boolean(IniFile.ReadInteger(SectionData, KeyConfirm, 0));
    ProgressCheckBox.IsChecked   := IniFile.ReadBool(SectionData, KeyProgress, False);
    UseMailMessageCheckBox.IsChecked := IniFile.ReadBool(SectionData, KeyUseOnGetData, False);
    Allow8BitCheckBox.IsChecked := IniFile.ReadBool(SectionData, KeyAllow8bit, True);
...
begin
    ...
    IniFile.WriteInteger(SectionData, KeyConfirm,  Ord(ConfirmCheckBox.IsChecked));
    IniFile.WriteBool(SectionData,    KeyProgress, ProgressCheckBox.IsChecked);
    IniFile.WriteBool(SectionData, KeyUseOnGetData, UseMailMessageCheckBox.IsChecked);
    IniFile.WriteBool(SectionData, KeyAllow8bit, Allow8BitCheckBox.IsChecked);
...
begin
    ...
    SmtpClient.ConfirmReceipt     := ConfirmCheckBox.IsChecked;
    PrepareProgressBar;
